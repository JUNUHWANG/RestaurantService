	...
	<!-- myorders list -->
		...
		<a name="list-myorders">
			<div class="myorders-info">
				<h1 class="myorders-heading">예약 추가 페이지</h1>
				<div class="underline">
					...
					<table class="table custom-table">
						<thead>
							<tr class="myorders-list-th">						
								...
								<tr><th scope="col">NAME</th><td><input type="text" name="id" value="${r.id.id}" readonly class="myorders-input"></td></tr>
								<tr><th scope="col">DATE</th><td><input type="date" name="day" value="${r.day}" class="myorders-input"></td></tr>
								<tr><th scope="col">TIME</th><td><input type="number" name="time" min="0" max="24" value="${r.time}" class="myorders-input">  시</td></tr>
								<tr><th scope="col">PERSON</th><td><input type="number" name="rev_cnt" value="${r.rev_cnt}" class="myorders-input">  명</td></tr>
								<tr><th scope="col">EDIT</th><td><input type="submit" value="EDIT" class="myorders-btn-table"></td></tr>
						</thead>
					</table>
					<input type="hidden" name="restaurant" value="${r.restaurant.restaurant_id }">
					<input type="hidden" name="rev_num" value="${r.rev_num }">
					</div>
					</form>
