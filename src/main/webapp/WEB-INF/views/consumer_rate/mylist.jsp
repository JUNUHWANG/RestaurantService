					...
					<div class="list">
						...
						<thead>
							<tr class="myorders-list-th">
								...
								<th scope="col">평점</th>
								<th scope="col">날짜</th>
								<th scope="col">후기 수정</th>
								<th scope="col">후기 삭제</th>
						</thead>
						<tbody>
							<c:forEach var="c" items="${list }">
								<tr scope="row">
									...
									<td>${c.rate }</td>
									<td>${c.wdate }</td>
									<td><input type="button" class="myorders-btn-table" value="후기 수정"
										onclick="edit(${c.c_num })"></td>
									<td><input type="button" class="myorders-btn-table" value="후기 삭제"
