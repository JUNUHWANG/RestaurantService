...
<body>
	...
	<div class="restaurant_write-content">
		...
		<tr><th scope="col">name</th><td scope="row"><input type="text" name="restaurantName" class="restaurant_write-input" class="restaurant_write-input"></td></tr>
		...
		<input type="checkbox" name="category" value="로컬맛집"><label for="로컬맛집">로컬맛집</label>
		<input type="checkbox" name="category" value="데이트"><label for="데이트">데이트</label>
		<input type="checkbox" name="category" value="단체/회식"><label for="단체/회식">단체/회식</label>
		<input type="checkbox" name="category" value="인스타감성"><label for="인스타감성">인스타감성</label>
		<input type="checkbox" name="category" value="포토존"><label for="포토존">포토존</label>
		<input type="checkbox" name="category" value="상견례"><label for="상견례">상견례</label>
		<input type="checkbox" name="category" value="공부하기좋은"><label for="공부하기좋은">공부하기좋은</label>
		<input type="checkbox" name="category" value="혼술/혼밥"><label for="혼술/혼밥">혼술/혼밥</label>
		<input type="checkbox" name="category" value="노포감성"><label for="노포감성">노포감성</label>
		<input type="checkbox" name="category" value="뷰맛집"><label for="뷰맛집">뷰맛집</label>
		</td></tr>
		...
		<input type="radio" name="restaurant_type" value="카페"><label for="카페">카페</label>
		<input type="radio" name="restaurant_type" value="베이커리"><label for="베이커리">베이커리</label>
		<input type="radio" name="restaurant_type" value="음식점"><label for="음식점">음식점</label>
		<input type="radio" name="restaurant_type" value="주점"><label for="주점">주점</label>
		</td></tr>
		<tr><th scope="col">menu type</th><td scope="row">
		<input type="radio" name="menu_type" value="한식"><label for="한식">한식</label>
		<input type="radio" name="menu_type" value="중식"><label for="중식">중식</label>
		<input type="radio" name="menu_type" value="일식"><label for="일식">일식</label>
		<input type="radio" name="menu_type" value="분식"><label for="분식">분식</label>
		<input type="radio" name="menu_type" value="레스토랑"><label for="레스토랑">레스토랑</label>
		<input type="radio" name="menu_type" value="패스트푸드"><label for="패스트푸드">패스트푸드</label>
		<input type="radio" name="menu_type" value="아시아음식"><label for="아시아음식">아시아음식</label>
		<input type="radio" name="menu_type" value="베이커리"><label for="베이커리">베이커리</label>
		<input type="radio" name="menu_type" value="커피/차"><label for="커피/차">커피/차</label>
		</td></tr>
		...
		<tr><th scope="col">add</th><td scope="row"><input type="submit" value="등록"></td></tr>
		</tbody>
		</table>
		</form>
		</div>
