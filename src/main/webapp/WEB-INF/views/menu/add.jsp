...
<body>
	...
	<section class="addmenu">
		...
		<div class="obwrite-wrapper">
			<h1 class="login-heading">add menu</h1>
			<div class="obwrite-content">
				<div class="underline">
					<div class="small-underline"></div>
					<div class="big-underline"></div>
				</div>
				<form action="/menu/add" class="obwrite-content-inside" method="post" enctype="multipart/form-data">
					<table class="table obwrite-table">
						<tr class="myorders-list-th">
							...
							<td scope="row"><input type="text" class="mypage-info-detail" name="restaurantname"
								value="${r.restaurantName }" readonly></td>
						</tr>
						<tr>
							<th scope="col">메뉴이름</th>
							<td scope="row"><input type="text"  class="mypage-info-detail" name="mname"></td>
						</tr>
						<tr>
							<th scope="col">가격</th>
							<td scope="row"><input type="number"  class="mypage-info-detail" name="price">원</td>
						</tr>
						<tr>
							<th scope="col">메뉴 상세정보</th>
							<td scope="row"><textarea rows="10" cols="30"  class="mypage-info-detail" name="m_summary"> </textarea></td>
						</tr>
						<tr>
							<th scope="col">메뉴 사진</th>
							<td scope="row"><input type="file" name="file"></td>
						</tr>
					</table>
							<input type="submit" class="ownerboard-btn" value="add"></td>
					<input type="hidden" name="resid" value="${r.restaurant_id }">
				</form>
			</div>
		</div>
	</section>
